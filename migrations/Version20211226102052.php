 ...
 */
final class Version20211226102052 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE rdv (kine_id INT NOT NULL, user_id INT NOT NULL, heure_debut VARCHAR(5) NOT NULL, date DATE NOT NULL, INDEX IDX_10C31F8688DC4BCC (kine_id), INDEX IDX_10C31F86A76ED395 (user_id), PRIMARY KEY(kine_id, user_id, heure_debut, date)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
